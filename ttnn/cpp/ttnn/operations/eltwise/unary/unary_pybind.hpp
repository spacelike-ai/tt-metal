...
void py_module(py::module& module) {
    ...
    detail::bind_unary_operation(module, ttnn::complex_rotate, R"doc((\mathrm{{output\_tensor}}_{2i}, \mathrm{{output\_tensor}}_{2i+1}) = (-\mathrm{{input\_tensor}}_{2i+1}, \mathrm{{input\_tensor}}_{2i}))doc", R"doc(FLOAT32, BFLOAT16, BFLOAT8_B, BFLOAT4_B)doc");
