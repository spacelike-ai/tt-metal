...
class ModelArgs:
    ...
    LOCAL_HF_PARAMS = {
        ...
        for k, v in {
            ...
            "FIBO-vlm": "models/tt_transformers/model_params/FIBO-vlm",
    ...
    def get_max_prefill_chunk_size(self):
        ...
        if max_prefill_chunk_size_div1024 is None:
            ...
            MAX_PREFILL_CHUNK_SIZES_DIV1024 = {
                ...
                # briaai/FIBO-vlm: a Qwen3-VL-4B-shaped prompt-structuring VLM for the FIBO text-to-image model
                "FIBO-vlm": {"N150": 64, "N300": 128, "T3K": 128, "TG": None, "P150x4": None, "P150x8": None},
